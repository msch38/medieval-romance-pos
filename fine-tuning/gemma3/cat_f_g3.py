...
modify dataset according to your needs
...
# Read sentences
with open("Llibre_reference.txt", "r") as f:
    sentences = [line.strip().split() for line in f]

# Read POS tags
df = pd.read_excel("Llibre_reference.xlsx")
all_tags = []
invalid_tags = set()
...
with open("chauliac_cat_naf_gemma3/tag2id_cat_f_g3.json", "w") as f:
    json.dump(tag2id, f)
    
with open("chauliac_cat_naf_gemma3/classification_report_cat_f_g3.txt", "w") as f:
    f.write(report)
